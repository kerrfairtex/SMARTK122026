 ...
 * @deprecated since 13.0 Use (new RosarioSIS\Functions\Hacking)->log() instead
 */
function HackingLog()
{
	trigger_error(
		'HackingLog() function is deprecated since RosarioSIS 13.0. Please use (new RosarioSIS\Functions\Hacking)->log() instead.',
		E_USER_DEPRECATED
	);
